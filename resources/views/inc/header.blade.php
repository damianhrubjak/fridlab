<header class="bg-pallette-black shadow-pallette-blue fixed top-0 left-0 z-20 w-full shadow-md">
    <div class="page-wrapper relative py-4">
        ...
        <div
            ...
            <a href="#"><i class="header-social-links fa-brands fa-twitter hover:text-[#1DA1F2]"></i></a>
            <a href="#"><i class="header-social-links fa-brands fa-youtube hover:text-[#FF0000]"></i></a>
            <a href="#"><i class="header-social-links fa-brands fa-discord hover:text-[#7289DA]"></i></a>
